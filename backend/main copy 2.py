...
def load_dividends_data():
    ...
    try:
        ...
        # print("Sample processed record:", _dividends_data[0] if _dividends_data else "No records") # Uncomment for detailed debug
...
async def get_dividends():
    ...
    # Sort raw_data by 'date_of_disbur' in descending order for display
    # Ensure 'date_of_disbur' exists and is comparable (string format YYYY-MM-DD)
